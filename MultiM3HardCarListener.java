...
//
        ...
        GameOver1(xc2, yc2 ,Xgenerate1, yEnemy1);
        GameOver1(xc2, yc2 ,Xgenerate2, yEnemy2);
        GameOver2(xc, yc ,Xgenerate3, yEnemy3);
        GameOver2(xc, yc ,Xgenerate4, yEnemy4);
    ...
    public void GameOver1(int x, int y , int Xgenerate1, int yEnemy1){
//        if((x == Xgenerate1 && y == yEnemy1) || (x == Xgenerate2 && y == yEnemy2) || (x == Xgenerate3 && y == yEnemy3) || (x == Xgenerate4 && y == yEnemy4)){
        if(x - 60 <= Xgenerate1 && x + 60 >= Xgenerate1  && y - 120 <= yEnemy1 && y + 120 >= yEnemy1){
            ...
            JOptionPane.showMessageDialog(null, "Player 1 won.", "Player 1 won",
    ...
    public void GameOver2(int x, int y , int Xgenerate1, int yEnemy1){
//        if((x == Xgenerate1 && y == yEnemy1) || (x == Xgenerate2 && y == yEnemy2) || (x == Xgenerate3 && y == yEnemy3) || (x == Xgenerate4 && y == yEnemy4)){
        if(x - 120 <= Xgenerate1 && x + 120 >= Xgenerate1  && y - 150 <= yEnemy1 && y + 150 >= yEnemy1){
            System.out.println("Player 2 won");
            JOptionPane.showMessageDialog(null, "Player 2 won.", "Player 2 won",
                    JOptionPane.WARNING_MESSAGE);
            System.exit(0);
        }
        //
